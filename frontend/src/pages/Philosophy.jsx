  ...
  return (
    <div className="pt-32 min-h-[140vh] bg-black text-white flex items-center justify-center overflow-x-hidden pb-40">
      ...
      <div className="relative w-0 h-0 flex items-center justify-center">
        ...
        {/* THE CENTRAL HUB (Force Circle) */}
        <motion.div 
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          className="absolute z-50 w-72 h-72 rounded-full bg-gradient-to-br from-orange-600 via-orange-500 to-yellow-500 p-[4px] shadow-[0_0_100px_rgba(234,88,12,0.4)]"
        >
          <div className="w-full h-full bg-black rounded-full flex flex-col items-center justify-center text-center p-6 border-2 border-black">
        ...
        {philosophyData.map((item, index) => (
          <motion.div
            ...
            transition={{ delay: 1.2 + (index * 0.1), type: "spring", damping: 18 }}
            className="absolute z-40 w-[300px]"
            style={{ x: "-50%", y: "-50%" }} // This centers the popup box on the arc endpoint
          >
            <div className="bg-zinc-950/95 backdrop-blur-md border border-orange-900/30 p-5 rounded-2xl hover:border-orange-500 transition-all group shadow-2xl">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-2 h-2 bg-orange-600 rounded-full group-hover:bg-yellow-400 shadow-[0_0_8px_rgba(234,88,12,0.8)]"></div>
